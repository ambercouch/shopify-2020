...
console.log('ajaxCart init')
  ...
  formOverride = function () {
      console.log('Form Override')
      console.log($formContainer)
    $formContainer.on('submit', function(evt) {
      evt.preventDefault();
      console.log('Form Override submit')
  ...
  buildCart = function (cart) {
    ...
    if (cart.item_count === 0) {
      $cartContainer
      .append('<div class="c-cart-drawer__notice"><p>' + "Your cart is currently empty." + '</p></div>');
      cartCallback(cart);
      return;
    }
    ...
    $.each(cart.items, function(index, cartItem) {
      ...
      */
      ...
      item = {
        ...
        sameday: settings.product_title_text,
  ...
  adjustCart = function () {
    ...
    $body.on('click', '.ajaxcart__qty-remove', function() {
        console.log('.ajaxcart__qty-remove')
      if (isUpdating) {
  ...
  adjustCartCallback = function (cart) {
    console.log('adjusting the cart no time out');
    // Update quantity and price
    updateCountPrice(cart);
