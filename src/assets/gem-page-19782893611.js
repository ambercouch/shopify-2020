        ...
        jQuery(function() {
            var $hero = jQuery('#m-1524487719607');
            var $module = jQuery('#m-1524487719607').children('.module');
            ...
            if($module.attr('data-fullheight') == '1'){
                ...
                $hero.attr('style', 'height: ' + wHeight + 'px!important');
        ...
        jQuery(function() {
            var $module = jQuery('#m-1514165030335').children('.module');
